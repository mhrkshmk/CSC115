...
/*
		...
		System.out.println("Returned: "+result);
*/
		System.out.println(A1Exercises.greatestCommonDenominator(3, 6));
		System.out.println(A1Exercises.greatestCommonDenominator(1, 1));
	...
	public static void testCountMatches() {
		...
		int[] arr2 = {2, 2, 2, 3};
		int[] arr3 = {};
		System.out.println(A1Exercises.countMatches(arr1, 2));
		System.out.println(A1Exercises.countMatches(arr2, 2));
		System.out.println(A1Exercises.countMatches(arr3, 2));		
		// add more arrays
/*
